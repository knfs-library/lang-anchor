...
const languageCons = require("./constants/languages");
const roleCons = require("./constants/roles");
const ResultFormClass = require("./resultForm");
const MissionClass = require("./mission");
...
class PromptTemplate {
	...
	/**
	 * Add enhanced contextual data to increase accuracy
	 * 
	 * @param {string} enhancedData - The enhanced contextual data to increase accuracy
	 */
