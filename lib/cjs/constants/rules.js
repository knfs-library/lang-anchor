...
/**
 * A collection of predefined prompt rules for working with LLMs (Large Language Models).
 * Each rule provides specific constraints to ensure high-quality responses.
 *
 * @typedef {Object} PromptRules
 */
